...
<head>
    ...
    <link href="${path}/resources/css/admin/admin_static_dailycost.css" rel="stylesheet"/>
    <style>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#glass").click(function(e){
			...
			staticAjax.oneDaySaleCost(searchDay,classify,error);
